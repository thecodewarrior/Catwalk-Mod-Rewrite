...
public class BlockSturdyRailBooster extends BlockRailPowered implements ISturdyTrackExtendable, IExtendable{
  	...
  	public boolean extend(World world, int _x, int _y, int _z,
  		...
  		for(ItemStack stack : inv.mainInventory) {
  			...
  			if(stack.getItem() instanceof ItemBlock &&
  					((ItemBlock) stack.getItem()).field_150939_a instanceof BlockSturdyRailBooster) {
